  ...
  return (
    <section className="begin" id="begin">
      <div className="begin-texth1">
        ...
        <p data-lang="pt" className="begin__title">
          <span className="line"></span>Licenciado em Engenharia Informática
        </p>
        <p data-lang="pt" className="begin__description">
          Fascinado pelo desenvolvimento Front-end, adoro criar websites e
          aprimorar as experiências do utilizador com desempenho e
        ...
        <p data-lang="en" style={{ display: "none" }} className="begin__title">
          <span className="line"></span>Degree in Computer Engineering
        </p>
        <p
          data-lang="en"
          style={{ display: "none" }}
          className="begin__description"
        >
          Fascinated by Front-end development, I love creating websites and
          improving user experiences with performance and accessibility in mind.
        </p>

        <a href="/CV-JoãoAraújo.pdf" className="btn" download data-lang="pt">
          Download do meu CV
        </a>
        <a
          href="/CV-JoãoAraújo.pdf"
          className="btn"
          download
          data-lang="en"
          style={{ display: "none" }}
